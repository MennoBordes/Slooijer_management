namespace Slooier_voorraad.Forms
{
	partial class DefaultForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.openOneToolStripMenuItem.Text = "OpenOne";
			this.openOneToolStripMenuItem.Click += new System.EventHandler(this.openOneToolStripMenuItem_Click_1);
			// 
			// openMultipleToolStripMenuItem
			// 
			this.openMultipleToolStripMenuItem.Name = "openMultipleToolStripMenuItem";
			this.openMultipleToolStripMenuItem.Size = new System.Drawing.Size(180, 22);
			this.openMultipleToolStripMenuItem.Text = "OpenMultiple";
			this.openMultipleToolStripMenuItem.Click += new System.EventHandler(this.openMultipleToolStripMenuItem_Click_1);
			// 
